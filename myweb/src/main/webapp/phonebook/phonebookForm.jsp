	...
	<section>
		...
		<article>
			<fieldset>
				...
				<h3>
					<a href="phonebookList1.jsp">모든 전화번호 내역보기 part1</a>
				</h3>
			</fieldset>
		</article>
		<article>
			<fieldset>
				...
				<h3>
					<a href="phonebookList2.jsp">모든 전화번호 내역보기 part2</a>
				</h3>
			</fieldset>
		</article>
		<article>
			<h2>전화번호검색 프로그램 1</h2>
			<form name="phoneSearch1" action="phoneSearch1_ok.jsp">
				<fieldset>
					...
					<table>
						<tr>
							...
							<td><input type="submit" value="회원 검색"></td>
						</tr>
					</table>
				</fieldset>
			</form>
		...
		<article>
			<h2>전화번호검색 프로그램 2</h2>
			<form name="phoneSearch2" action="phoneSearch2_ok.jsp">
				<fieldset>
					<legend>전화번호 검색 part2</legend>
					<table>
						<tr>
							<th>회원이름</th>
							<td><input type="text" name="name"></td>
